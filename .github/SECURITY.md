...
1. **Matrix (Encrypted):** Message me directly at [@mlmistaken:matrix.org](https://matrix.to/#/@mlmistaken:matrix.org) or join our support room [#mages-sec-support:matrix.org](https://matrix.to/#/#mages-sec-support:matrix.org).
2. **Email:** Send details to [mlm.gamestudio@gmail.com](mailto:mlm.gamestudio@gmail.com).
...
<!-- (If you are submitting through a bug bounty program, please still follow the private reporting guidelines above to ensure responsible disclosure.) -->
